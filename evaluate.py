...
Usage:
    ...
    python evaluate.py --model models/ppo_lunarlander_seed42/best_model --render
...
def evaluate(args):
    ...
    if args.record:
        ...
        video_path = os.path.join(config.VIDEO_DIR, "lunarlander_eval.mp4")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--record", action="store_true",
                        help="Record a video to videos/lunarlander_eval.mp4")
